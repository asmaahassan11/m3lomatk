  ...
  Column _buildBottomNavigationMenu() {
    return Column(
      ...
      children: <Widget>[
        ...
        Text("Open the WhatsApp app and go to your profile . Your WhatsApp username will be at the top of your screen .",style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black45),),
        SizedBox(height: 10,),
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
