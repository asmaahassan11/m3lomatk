  ...
  Column _buildBottomNavigationMenu() {
    return Column(
      ...
      children: <Widget>[
        ...
        Text("Open the FaceBook app and go to your profile . Your FaceBook username will be at the top of your screen .",style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black45),),
        SizedBox(height: 10,),
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
