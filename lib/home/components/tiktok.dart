...
class _TikTokState extends State<TikTok> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: <Widget>[
        SocalIcon(
          iconSrc: "assets/icons/tiktok-round.svg",
          press: () {
  ...
  Column _buildBottomNavigationMenu() {
    return Column(
      ...
      children: <Widget>[
        ...
        SizedBox(height: 10,),
        ProfileIcon(
          icon: "assets/icons/tiktok-round.svg",
          text: "Instagram Username",
          press: () {},
        ),
        Text("Open the TikTok app and go to your profile . Your TikTok username will be at the top of your screen .",style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black45),),
        SizedBox(height: 10,),
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
