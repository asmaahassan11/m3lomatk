  ...
  Column _buildBottomNavigationMenu() {
    return Column(
      ...
      children: <Widget>[
        ...
        Text("Open the Instagram app and go to your profile . Your Instagram username will be at the top of your screen .",style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black45),),
        SizedBox(height: 10,),
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
